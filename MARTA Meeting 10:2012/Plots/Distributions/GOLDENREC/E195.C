...
//=========  (Fri Oct 19 00:24:13 2012) by ROOT version5.30/00
   TCanvas *DataDist = new TCanvas("DataDist", "cf",20,42,800,800);
   gStyle->SetOptStat(0);
   DataDist->Range(-2375001,-0.04464652,1.11375e+08,0.4018187);
   ...
   TH1D *hmuFe__1 = new TH1D("hmuFe__1","",30,9000000,1e+08);
   hmuFe__1->SetBinContent(8,0.01639344);
   hmuFe__1->SetBinContent(9,0.1352459);
   hmuFe__1->SetBinContent(10,0.307377);
   hmuFe__1->SetBinContent(11,0.3401639);
   hmuFe__1->SetBinContent(12,0.1393443);
   hmuFe__1->SetBinContent(13,0.03278689);
   hmuFe__1->SetBinContent(14,0.02459016);
   hmuFe__1->SetBinContent(16,0.004098361);
   hmuFe__1->SetEntries(244);
   ...
   TH1D *hmuP__2 = new TH1D("hmuP__2","hmuP",30,9000000,1e+08);
   hmuP__2->SetBinContent(4,0.01659751);
   hmuP__2->SetBinContent(5,0.07883817);
   hmuP__2->SetBinContent(6,0.1244813);
   hmuP__2->SetBinContent(7,0.2240664);
   hmuP__2->SetBinContent(8,0.2697095);
   hmuP__2->SetBinContent(9,0.153527);
   hmuP__2->SetBinContent(10,0.0746888);
   hmuP__2->SetBinContent(11,0.03319502);
   hmuP__2->SetBinContent(12,0.01659751);
   ...
   TH1D *HistDATA__3 = new TH1D("HistDATA__3","HistDATA",30,9000000,1e+08);
   HistDATA__3->SetBinContent(0,0.75);
   HistDATA__3->SetBinContent(15,0.25);
   HistDATA__3->SetBinContent(18,0.25);
   HistDATA__3->SetBinContent(21,0.25);
   HistDATA__3->SetBinContent(25,0.25);
   HistDATA__3->SetEntries(7);
